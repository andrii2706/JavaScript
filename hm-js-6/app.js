...
// let ua = new UserAppender();
// ua.buildBlocksForUsers(users)
...
//    Блок з адресою зробити окремим блоком, з блоками для кожної властивості
            ...
            //      userContainer.innerText = `${user.address.city} ${user.address.country} ${user.address.street} ${user.address.houseNumber}`;   
            //      document.body.append(userContainer)
            //     }
